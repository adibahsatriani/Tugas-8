...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="formdataibu.php">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="namaayah" id="namaayah"
                            ...
                            placeholder="Nama Ayah" value="<?php echo $nama; ?>"> <span
                            class="warning"><?php echo $error_nama ?></span>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="nomerps" class="col-sm-2 col-form-label">Tahun Lahir</label>
                    <div class="col-sm-10">
                        <input type="text" name="lahirayah" id="lahirayah"
